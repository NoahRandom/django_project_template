...
SECRET_KEY = 'django-insecure-zcp!t)t&4bev2#!w5gjpcubv2ks(g2ejokfu(b9*yckk6y^^5v'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['52.204.52.247', 'localhost','0.0.0.0']
...
#         'NAME': '<name_of_your_postgres_db>',
#         'USER': '<postgress_user_for_this_db>',
#         'PASSWORD': '<password_for_your_postgresql_user>',
#         'HOST': 'localhost', # or the ip address of your db server
#         'PORT': '<postgress_server_port>'
#     }
# }
